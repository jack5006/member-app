...
export const ICONS = {
  ...
  Brain: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 2A5 5 0 0 1 12 10a5 5 0 1 1 2.5-8"/><path d="M12 10s.5-1 2-1 3 1 3 3-1 3-3 3h-2v4h-2V12h-2c-2 0-3-1-3-3s1-3 3-3 2 1 2 1z"/><path d="M9 22c0-1.5 1-2 3-2s3 .5 3 2"/></svg>
  ),
  Download: () => (
